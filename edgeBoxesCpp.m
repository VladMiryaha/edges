function bbs = edgeBoxesCpp( I, model, varargin )
...
function bbs = edgeBoxesImg( I, model_path, o )
% Generate Edge Boxes object proposals in single image.
if(all(ischar(I))), I=imread(I); end
bbs=edge_boxes_mex(I,model_path,o.alpha,o.beta,o.eta,o.minScore,o.maxBoxes,...
